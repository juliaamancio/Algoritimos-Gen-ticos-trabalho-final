...
def funcoes_objetivo(candidato):
    ...
    B1 = 0.5 * np.sin(candidato[0]) - 2*np.cos(candidato[0]) + np.sin(candidato[1]) - 1.5*np.cos(candidato[1])
    A2 = 1.5*np.sin(1) - np.cos(1) + 2*np.sin(2) - 0.5*np.cos(2)
    B2 = 1.5*np.sin(candidato[0]) - np.cos(candidato[0]) + 2*np.sin(candidato[1]) - 0.5*np.cos(candidato[1])
    
    f1 = 1 + (A1 - B1)**2 + (A2 - B2)**2
    f2 = (candidato[0] + 3)**2 + (candidato[1] + 1)**2
